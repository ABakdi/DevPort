        ...
        <div className="relative min-h-[400px] bg-[#3A5F5F] rounded-lg overflow-hidden flex items-center justify-center">
          ...
          <div className="bg-white/10 backdrop-blur-md p-4 rounded-xl border border-white/20 w-3/4 transform hover:scale-105 transition-transform duration-500 shadow-2xl">
            <div className="rounded-lg shadow-inner bg-slate-800 aspect-video flex items-center justify-center">
              <span className="text-white/50 font-mono text-sm">Project Dashboard Preview</span>
            </div>
          </div>
        </div>
        ...
        <div className="p-8 lg:p-12 flex flex-col justify-center">
          <div className="mb-4">
            ...
            <h3 className="text-4xl font-black text-slate-900 dark:text-white leading-tight mb-4 tracking-tighter">
              Enterprise Data Lake Engine
            </h3>
            <p className="text-slate-600 dark:text-slate-400 text-lg mb-8 leading-relaxed">
              A proprietary data ingestion engine designed for high-throughput financial transactions. Features real-time validation and automated schema discovery with 99.9% uptime.
            </p>
          </div>

          <div className="flex gap-4 mb-10">
            <div className="flex-1 bg-slate-50 dark:bg-[#0a0a0a] p-6 rounded-2xl border border-slate-200 dark:border-[#1F2937]">
              <p className="text-2xl font-black text-slate-900 dark:text-white">4.2ms</p>
              <p className="text-[10px] font-bold text-slate-500 uppercase tracking-widest">Avg Latency</p>
            </div>
            <div className="flex-1 bg-slate-50 dark:bg-[#0a0a0a] p-6 rounded-2xl border border-slate-200 dark:border-[#1F2937]">
              <p className="text-2xl font-black text-slate-900 dark:text-white">128TB+</p>
              <p className="text-[10px] font-bold text-slate-500 uppercase tracking-widest">Processed</p>
            </div>
          </div>

          <div className="flex items-center gap-4">
            <Button className="flex-1 bg-[#00E5FF] text-black font-bold py-4 rounded-xl flex items-center justify-center gap-2 hover:shadow-[0_0_15px_rgba(0,229,255,0.4)] transition-all group">
              VIEW CASE STUDY
